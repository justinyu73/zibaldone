...
- **Honest engineering.** 76 API endpoints locked by a surface-contract test,
  320+ backend tests, 24 Playwright E2E cases, release gated on CI, and a size
...
The public source is ready to build locally. Platform installers will be published
under [Releases](https://github.com/justinyu73/zibaldone/releases) after the first
clean public tag; the planned artifacts are a Windows NSIS installer and a macOS
DMG (Apple Silicon).
