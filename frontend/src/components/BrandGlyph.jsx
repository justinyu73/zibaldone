...
export function brandGlyphKey(name) {
  ...
  if (b === 'cli' || b.includes('訂閱') || b.includes('codex')) return 'cli'
  ...
  if (b.includes('llamacpp') || b.includes('llama') || b.includes('gemma') || b.includes('本機') || b === 'local') return 'local'
  return 'generic'
}
...
const GLYPHS = {
  ...
  local: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="13" height="13"><rect x="5" y="9" width="14" height="10" rx="2" /></svg>,
  cli: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="13" height="13"><path d="m4 17 6-6-6-6M12 19h8" /></svg>,
