...
describe('toWslPath', () => {
  it('converts a Windows path to the WSL mount path', () => {
    expect(toWslPath('C:\\Users\\TestUser\\Vault\\YouTube')).toBe('/mnt/c/Users/TestUser/Vault/YouTube')
  })
  ...
  it('handles mixed slashes', () => {
    expect(toWslPath('C:\\Users\\TestUser/Vault')).toBe('/mnt/c/Users/TestUser/Vault')
  })

  it('leaves a WSL/POSIX path untouched', () => {
    expect(toWslPath('/mnt/c/Users/TestUser/Vault')).toBe('/mnt/c/Users/TestUser/Vault')
...
describe('deriveVaultPaths', () => {
  ...
  it('normalizes Windows paths and trailing slashes', () => {
    const p = deriveVaultPaths('C:\\Users\\TestUser\\notes\\note_study\\')
    expect(p.root).toBe('/mnt/c/Users/TestUser/notes/note_study')
    expect(p.youtube).toBe('/mnt/c/Users/TestUser/notes/note_study/02_Sources/youtube')
  })
